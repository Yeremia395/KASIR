...
public class sepatu {
    ...
    public void hasil() {
        ...
        System.out.println("\n       Jl. doang jadian enggak");
        System.out.println("\n----------------------------------------");
        System.out.println("\nTanggal\t " + getTanggal());
        System.out.println("Waktu\t " + getWaktu());
        System.out.println("\n----------------------------------------");
        System.out.println("\nNama pembeli\t "+this.nama);
        System.out.println("\nJenis sepatu\t " + this.jenis);
        System.out.println("\nKategori sepatu\t " + this.kategori);
        System.out.println("\nMerk sepatu\t " + this.merk);
        System.out.println("\nWarna sepatu\t " + this.warna);
        System.out.println("\nSize sepatu\t " + this.size);
    ...
    public void hasildiskon() {
        ...
        this.harga = temp;
        System.out.println("\nKarena beli 2 pasang, Anda mendapatkan diskon Rp. 50.000");
        System.out.println("\nTotal harga\t " + this.harga);
        System.out.println("\n----------------------------------------");
        System.out.println("\n-------------TERIMA KASIH---------------");
        System.out.println("\n");
    ...
    public void hasildiskon3() {
        ...
        this.harga = temp;
        System.out.println("\nKarena beli 3 pasang, Anda mendapatkan diskon Rp. 100.000");
        System.out.println("\nTotal harga\t " + this.harga);
        System.out.println("\n----------------------------------------");
        System.out.println("\n-------------TERIMA KASIH---------------");
        System.out.println("\n");
